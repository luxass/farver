...
describe("should downscale true colors", () => {
  describe("truecolors -> ansi16", () => {
    ...
    it("handle nested colors", () => {
      ...
      const received = colors.bgHex("#1BE011")(colors.hex("#11D9C2")("nested"));
      const expected = colors.bgGreen(colors.cyan("nested"));
  ...
  describe("truecolors -> ansi256", () => {
    ...
    it("handle nested colors", () => {
      ...
      const received = colors.bgHex("#1BE011")(colors.hex("#11D9C2")("nested"));
      const expected = colors.bg(76)(colors.fg(44)("nested"));
